...
export class App extends React.Component {
    ...
    constructor(){
        ...
        this.state = {
            ...
            api: {
                ...
                recoveriesData: '02b3324d-d819-404a-b3f4-0dde26977852',
    ...
    componentDidMount() {
        ...
        axios.get(self.state.api.baseUrl + 'action/datastore_search?resource_id=' + self.state.api.recoveriesData + '&limit=100000')
        .then(function(response) {
            ...
            self.setState({
                ...
                selectedDateData: _.orderBy(_.filter(self.state.data, function(o) { return (o.date == dates[dates.length-1] && o.offset_recovery_ratio != null && o.offset_recovery_ratio != 'NaN') }),['offset_recovery_ratio'],['desc']),
                selectedDateDataMap: _.orderBy(_.filter(self.state.data, function(o) { return (o.date == dates[dates.length-1]) }),['offset_recovery_ratio'],['desc'])
            });
    ...
    onUpdate = (render, handle, value, un, percent) => {
        ...
        this.setState({
          ...
          selectedDateData: _.orderBy(_.filter(self.state.data, function(o) { return (o.date == self.state.dates[parseInt(value[0]-1)] && o.offset_recovery_ratio != null && o.offset_recovery_ratio != 'NaN') }),['offset_recovery_ratio'],['desc']),
          selectedDateDataMap: _.orderBy(_.filter(self.state.data, function(o) { return (o.date == self.state.dates[parseInt(value[0]-1)]) }),['offset_recovery_ratio'],['desc'])
        });
    ...
    dateSelect = (e) => {
        ...
        if(dateCount > -1) {
            self.setState({
                ...
                selectedDateData: _.orderBy(_.filter(self.state.data, function(o) { return (o.date == self.state.dates[dateCount] && o.offset_recovery_ratio != null && o.offset_recovery_ratio != 'NaN') }),['offset_recovery_ratio'],['desc']),
                selectedDateDataMap: _.orderBy(_.filter(self.state.data, function(o) { return (o.date == self.state.dates[dateCount]) }),['offset_recovery_ratio'],['desc'])
            });
    ...
    playTimeline = () => {
        ...
        if (self.state.currentDateCount < self.state.dates.length-1) {
            ...
            self.setState({
                ...
                selectedDateData: _.orderBy(_.filter(self.state.data, function(o) { return (o.date == self.state.dates[self.state.currentDateCount] && o.offset_recovery_ratio != null && o.offset_recovery_ratio != 'NaN') }),['offset_recovery_ratio'],['desc']),
                selectedDateDataMap: _.orderBy(_.filter(self.state.data, function(o) { return (o.date == self.state.dates[self.state.currentDateCount]) }),['offset_recovery_ratio'],['desc'])
            });
    ...
    jumpToLatest = () => {
        ...
        this.setState({
            ...
            selectedDateData: _.orderBy(_.filter(self.state.data, function(o) { return (o.date == self.state.dates[self.state.dates.length-1] && o.offset_recovery_ratio != null && o.offset_recovery_ratio != 'NaN') }),['offset_recovery_ratio'],['desc']),
            selectedDateDataMap: _.orderBy(_.filter(self.state.data, function(o) { return (o.date == self.state.dates[self.state.dates.length-1]) }),['offset_recovery_ratio'],['desc'])
        });
                    ...
                    <Row>
                        {this.state.selectedCountries.length > 0 && window.innerWidth < 800 ? '' :
                            <Col lg={6} className="mb-4">
                                    <RecoveriesMap onCountrySelect={this.countrySelect} data={this.state.selectedDateDataMap} onModeSwitch={this.onModeSwitch} definitions={this.state.definitions}/>
                            </Col>
                        }
                        <Col>
                            { 
